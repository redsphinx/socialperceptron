...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_88.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_88.txt'
##
TEST_LOG = '/scratch/users/gabras/data/loss/test_88.txt'
PREDICTION_LOG = '/scratch/users/gabras/data/loss/pred_87.txt'
