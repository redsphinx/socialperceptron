...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_22.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_22.txt'
TEST_LOG = '/scratch/users/gabras/data/loss/test_23.txt'
