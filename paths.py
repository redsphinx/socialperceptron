...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_63.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_63.txt'
##
TEST_LOG = '/scratch/users/gabras/data/loss/test_63.txt'
