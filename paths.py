...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_35.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_35.txt'
##
TEST_LOG = '/scratch/users/gabras/data/loss/test_43.txt'
