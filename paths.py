...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_53.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_53.txt'
##
TEST_LOG = '/scratch/users/gabras/data/loss/test_56.txt'
