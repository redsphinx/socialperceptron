...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_59_O.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_59_O.txt'
##
TEST_LOG = '/scratch/users/gabras/data/loss/test_59.txt'
