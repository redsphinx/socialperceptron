...
TRAIN_LOG = '/scratch/users/gabras/data/loss/train_44.txt'
VAL_LOG = '/scratch/users/gabras/data/loss/val_44.txt'
##
TEST_LOG = '/scratch/users/gabras/data/loss/test_52.txt'
